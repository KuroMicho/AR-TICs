...
namespace YoutubePlayer
{
    ...
    public class YoutubePlayer : MonoBehaviour
    {
        ...
        public static async Task<string> GetRawVideoUrlAsync(
            string videoUrl,
            YoutubeDlOptions options = null,
            CancellationToken cancellationToken = default
        )
        {
            options = options ?? YoutubeDlOptions.Default;
            var metaData = await YoutubeDl.GetVideoMetaDataAsync<YoutubeVideoMetaData>(
                videoUrl,
                options,
                k_PlayFields,
                cancellationToken
        ...
        )
        {
            ...
            var rawUrl = await GetRawVideoUrlAsync(
                videoUrl,
                downloader,
                options,
                cancellationToken
        ...
        )
        {
            videoUrl = videoUrl ?? youtubeUrl;
            var downloader = GetCli(cli);
            var video = await YoutubeDl.GetVideoMetaDataAsync<YoutubeVideoMetaData>(
                videoUrl,
